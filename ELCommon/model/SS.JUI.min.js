(function(d){"function"===typeof define&&define.amd?define(["jquery"],d):d(jQuery)})(function(d){function R(a,b){var c,f;c=a.nodeName.toLowerCase();if("area"===c){c=a.parentNode;f=c.name;if(!a.href||!f||"map"!==c.nodeName.toLowerCase())return!1;c=d("img[usemap='#"+f+"']")[0];return!!c&&S(c)}return(/^(input|select|textarea|button|object)$/.test(c)?!a.disabled:"a"===c?a.href||b:b)&&S(a)}function S(a){return d.expr.filters.visible(a)&&!d(a).parents().addBack().filter(function(){return"hidden"===d.css(this,
...
d(this).removeClass("ui-datepicker-next-hover")}).delegate("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a","mouseover",V)}function V(){d.datepicker._isDisabledDatepicker(A.inline?A.dpDiv.parent()[0]:A.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&
d(this).addClass("ui-datepicker-next-hover"))}function K(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function E(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.extend(d.ui,{version:"1.11.4",keyCode:{BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38}});d.fn.extend({scrollParent:function(a){var b=
...
b||"fixed"===b)if(b=parseInt(a.css("zIndex"),10),!isNaN(b)&&0!==b)return b;a=a.parent()}}return 0}});d.ui.plugin={add:function(a,b,c){var f;a=d.ui[a].prototype;for(f in c)a.plugins[f]=a.plugins[f]||[],a.plugins[f].push([b,c[f]])},call:function(a,b,c,d){if((b=a.plugins[b])&&(d||a.element[0].parentNode&&11!==a.element[0].parentNode.nodeType))for(d=0;d<b.length;d++)a.options[b[d][0]]&&b[d][1].apply(a.element,c)}};var $=0,W=Array.prototype.slice;d.cleanData=function(a){return function(b){var c,f,e;for(e=
...
b){var c=b.prototype.widgetFullName||a;d.fn[a]=function(f){var e="string"===typeof f,g=W.call(arguments,1),h=this;e?this.each(function(){var b,e=d.data(this,c);if("instance"===f)return h=e,!1;if(!e)return d.error("cannot call methods on "+a+" prior to initialization; attempted to call method '"+f+"'");if(!d.isFunction(e[f])||"_"===f.charAt(0))return d.error("no such method '"+f+"' for "+a+" widget instance");b=e[f].apply(e,g);if(b!==e&&void 0!==b)return h=b&&b.jquery?h.pushStack(b.get()):b,!1}):(g.length&&
(f=d.widget.extend.apply(null,[f].concat(g))),this.each(function(){var a=d.data(this,c);a?(a.option(f||{}),a._init&&a._init()):d.data(this,c,new b(f,this))}));return h}};d.Widget=function(){};d.Widget._childConstructors=[];d.Widget.prototype={widgetName:"widget",widgetEventPrefix:"",defaultElement:"<div>",options:{disabled:!1,create:null},_createWidget:function(a,b){b=d(b||this.defaultElement||this)[0];this.element=d(b);this.uuid=$++;this.eventNamespace="."+this.widgetName+this.uuid;this.bindings=
...
hide:"fadeOut"},function(a,b){d.Widget.prototype["_"+a]=function(c,f,e){"string"===typeof f&&(f={effect:f});var g,h=f?!0===f||"number"===typeof f?b:f.effect||b:a;f=f||{};"number"===typeof f&&(f={duration:f});g=!d.isEmptyObject(f);f.complete=e;f.delay&&c.delay(f.delay);if(g&&d.effects&&d.effects.effect[h])c[a](f);else if(h!==a&&c[h])c[h](f.duration,f.easing,e);else c.queue(function(b){d(this)[a]();e&&e.call(c[0]);b()})}});var O=!1;d(document).mouseup(function(){O=!1});d.widget("ui.mouse",{version:"1.11.4",
...
offset:a.offset()||{left:0,top:0},scrollLeft:a.scrollLeft(),scrollTop:a.scrollTop(),width:b||c?a.width():a.outerWidth(),height:b||c?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var r,s,u,n,v,C,x=d(c.of),B=d.position.getWithinInfo(c.within),y=d.position.getScrollInfo(B),J=(c.collision||"flip").split(" "),L={};C=b(x);x[0].preventDefault&&(c.at="left top");s=C.width;u=C.height;n=C.offset;v=d.extend({},n);d.each(["my","at"],function(){var a=
(c[this]||"").split(" "),b,d;1===a.length&&(a=k.test(a[0])?a.concat(["center"]):l.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=l.test(a[1])?a[1]:"center";b=m.exec(a[0]);d=m.exec(a[1]);L[this]=[b?b[0]:0,d?d[0]:0];c[this]=[p.exec(a[0])[0],p.exec(a[1])[0]]});1===J.length&&(J[1]=J[0]);"right"===c.at[0]?v.left+=s:"center"===c.at[0]&&(v.left+=s/2);"bottom"===c.at[1]?v.top+=u:"center"===c.at[1]&&(v.top+=u/2);r=a(L.at,s,u);v.left+=r[0];v.top+=r[1];return this.each(function(){var b,
l,k=d(this),m=k.outerWidth(),p=k.outerHeight(),q=parseInt(d.css(this,"marginLeft"),10)||0,C=parseInt(d.css(this,"marginTop"),10)||0,A=m+q+(parseInt(d.css(this,"marginRight"),10)||0)+y.width,E=p+C+(parseInt(d.css(this,"marginBottom"),10)||0)+y.height,w=d.extend({},v),G=a(L.my,k.outerWidth(),k.outerHeight());"right"===c.my[0]?w.left-=m:"center"===c.my[0]&&(w.left-=m/2);"bottom"===c.my[1]?w.top-=p:"center"===c.my[1]&&(w.top-=p/2);w.left+=G[0];w.top+=G[1];f||(w.left=h(w.left),w.top=h(w.top));b={marginLeft:q,
marginTop:C};d.each(["left","top"],function(a,f){if(d.ui.position[J[a]])d.ui.position[J[a]][f](w,{targetWidth:s,targetHeight:u,elemWidth:m,elemHeight:p,collisionPosition:b,collisionWidth:A,collisionHeight:E,offset:[r[0]+G[0],r[1]+G[1]],my:c.my,at:c.at,within:B,elem:k})});c.using&&(l=function(a){var b=n.left-w.left,d=b+s-m,f=n.top-w.top,h=f+u-p,l={target:{element:x,left:n.left,top:n.top,width:s,height:u},element:{element:k,left:w.left,top:w.top,width:m,height:p},horizontal:0>d?"left":0<b?"right":"center",
vertical:0>h?"top":0<f?"bottom":"middle"};s<m&&g(b+d)<s&&(l.horizontal="center");u<p&&g(f+h)<u&&(l.vertical="middle");e(g(b),g(d))>e(g(f),g(h))?l.important="horizontal":l.important="vertical";c.using.call(this,a,l)});k.offset(d.extend(w,{using:l}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,f=c.width,g=a.left-b.collisionPosition.marginLeft,c=d-g,h=g+b.collisionWidth-f-d;b.collisionWidth>f?0<c&&0>=h?(d=a.left+c+b.collisionWidth-f-d,a.left+=c-d):
...
d.widget("ui.autocomplete",d.ui.autocomplete,{options:{messages:{noResults:"No search results.",results:function(a){return a+(1<a?" results are":" result is")+" available, use up and down arrow keys to navigate."}}},__response:function(a){var b;this._superApply(arguments);this.options.disabled||this.cancelSearch||(b=a&&a.length?this.options.messages.results(a.length):this.options.messages.noResults,this.liveRegion.children().hide(),d("<div>").text(b).appendTo(this.liveRegion))}});var Q,aa=function(){var a=
d(this);setTimeout(function(){a.find(":ui-button").button("refresh")},1)},X=function(a){var b=a.name,c=a.form,f=d([]);b&&(b=b.replace(/'/g,"\\'"),f=c?d(c).find("[name='"+b+"'][type=radio]"):d("[name='"+b+"'][type=radio]",a.ownerDocument).filter(function(){return!this.form}));return f};d.widget("ui.button",{version:"1.11.4",defaultElement:"<button>",options:{disabled:null,text:!0,label:null,icons:{primary:null,secondary:null}},_create:function(){this.element.closest("form").unbind("reset"+this.eventNamespace).bind("reset"+
this.eventNamespace,aa);"boolean"!==typeof this.options.disabled?this.options.disabled=!!this.element.prop("disabled"):this.element.prop("disabled",this.options.disabled);this._determineButtonType();this.hasTitle=!!this.buttonElement.attr("title");var a=this,b=this.options,c="checkbox"===this.type||"radio"===this.type,f=c?"":"ui-state-active";null===b.label&&(b.label="input"===this.type?this.buttonElement.val():this.buttonElement.html());this._hoverable(this.buttonElement);this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role",
"button").bind("mouseenter"+this.eventNamespace,function(){b.disabled||this===Q&&d(this).addClass("ui-state-active")}).bind("mouseleave"+this.eventNamespace,function(){b.disabled||d(this).removeClass(f)}).bind("click"+this.eventNamespace,function(a){b.disabled&&(a.preventDefault(),a.stopImmediatePropagation())});this._on({focus:function(){this.buttonElement.addClass("ui-state-focus")},blur:function(){this.buttonElement.removeClass("ui-state-focus")}});c&&this.element.bind("change"+this.eventNamespace,
function(){a.refresh()});"checkbox"===this.type?this.buttonElement.bind("click"+this.eventNamespace,function(){if(b.disabled)return!1}):"radio"===this.type?this.buttonElement.bind("click"+this.eventNamespace,function(){if(b.disabled)return!1;d(this).addClass("ui-state-active");a.buttonElement.attr("aria-pressed","true");var c=a.element[0];X(c).not(c).map(function(){return d(this).button("widget")[0]}).removeClass("ui-state-active").attr("aria-pressed","false")}):(this.buttonElement.bind("mousedown"+
this.eventNamespace,function(){if(b.disabled)return!1;d(this).addClass("ui-state-active");Q=this;a.document.one("mouseup",function(){Q=null})}).bind("mouseup"+this.eventNamespace,function(){if(b.disabled)return!1;d(this).removeClass("ui-state-active")}).bind("keydown"+this.eventNamespace,function(a){if(b.disabled)return!1;a.keyCode!==d.ui.keyCode.SPACE&&a.keyCode!==d.ui.keyCode.ENTER||d(this).addClass("ui-state-active")}).bind("keyup"+this.eventNamespace+" blur"+this.eventNamespace,function(){d(this).removeClass("ui-state-active")}),
...
!!b),this.element.prop("disabled",!!b),b&&("checkbox"===this.type||"radio"===this.type?this.buttonElement.removeClass("ui-state-focus"):this.buttonElement.removeClass("ui-state-focus ui-state-active"))):this._resetButton()},refresh:function(){var a=this.element.is("input, button")?this.element.is(":disabled"):this.element.hasClass("ui-button-disabled");a!==this.options.disabled&&this._setOption("disabled",a);"radio"===this.type?X(this.element[0]).each(function(){d(this).is(":checked")?d(this).button("widget").addClass("ui-state-active").attr("aria-pressed",
...
d.extend(d.ui,{datepicker:{version:"1.11.4"}});var A;d.extend(T.prototype,{markerClassName:"hasDatepicker",maxRows:4,_widgetDatepicker:function(){return this.dpDiv},setDefaults:function(a){K(this._defaults,a||{});return this},_attachDatepicker:function(a,b){var c,f,e;c=a.nodeName.toLowerCase();f="div"===c||"span"===c;a.id||(this.uuid+=1,a.id="dp"+this.uuid);e=this._newInst(d(a),f);e.settings=d.extend({},b||{});"input"===c?this._connectDatepicker(a,e):f&&this._inlineDatepicker(a,e)},_newInst:function(a,
...
this._dialogInput.keydown(this._doKeyDown),d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));K(a.settings,f||{});b=b&&b.constructor===Date?this._formatDate(a,b):b;this._dialogInput.val(b);this._pos=e?e.length?e:[e.pageX,e.pageY]:null;this._pos||(b=document.documentElement.clientWidth,f=document.documentElement.clientHeight,e=document.documentElement.scrollLeft||document.body.scrollLeft,g=document.documentElement.scrollTop||
...
d.datepicker._curInst!==b&&(d.datepicker._curInst.dpDiv.stop(!0,!0),b&&d.datepicker._datepickerShowing&&d.datepicker._hideDatepicker(d.datepicker._curInst.input[0]));c=(c=d.datepicker._get(b,"beforeShow"))?c.apply(a,[a,b]):{};if(!1!==c&&(K(b.settings,c),b.lastVal=null,d.datepicker._lastInput=a,d.datepicker._setDateFromField(b),d.datepicker._inDialog&&(a.value=""),d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight),f=!1,d(a).parents().each(function(){f|=
...
Z(d(a))+1);d.datepicker._datepickerShowing=!0;if(d.effects&&d.effects.effect[c])b.dpDiv.show(c,d.datepicker._get(b,"showOptions"),e);else b.dpDiv[c||"show"](c?e:null);d.datepicker._shouldFocusInput(b)&&b.input.focus();d.datepicker._curInst=b}}},_updateDatepicker:function(a){this.maxRows=4;A=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b,c=this._getNumberOfMonths(a),f=c[1],e=a.dpDiv.find("."+this._dayOverClass+" a");0<e.length&&V.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");
...
d,e,g,h,k,l,m,p,n,q,t,r,s,u,F,v,C,x,B,y,J,L,N,M,P,A=new Date,A=this._daylightSavingAdjust(new Date(A.getFullYear(),A.getMonth(),A.getDate())),H=this._get(a,"isRTL");h=this._get(a,"showButtonPanel");d=this._get(a,"hideIfNoPrevNext");g=this._get(a,"navigationAsDateFormat");var I=this._getNumberOfMonths(a),z=this._get(a,"showCurrentAtPos");e=this._get(a,"stepMonths");var E=1!==I[0]||1!==I[1],K=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,
9)),w=this._getMinMaxDate(a,"min"),G=this._getMinMaxDate(a,"max"),z=a.drawMonth-z,D=a.drawYear;0>z&&(z+=12,D--);if(G)for(b=this._daylightSavingAdjust(new Date(G.getFullYear(),G.getMonth()-I[0]*I[1]+1,G.getDate())),b=w&&b<w?w:b;this._daylightSavingAdjust(new Date(D,z,1))>b;)z--,0>z&&(z=11,D--);a.drawMonth=z;a.drawYear=D;b=this._get(a,"prevText");b=g?this.formatDate(b,this._daylightSavingAdjust(new Date(D,z-e,1)),this._getFormatConfig(a)):b;b=this._canAdjustMonth(a,-1,D,z)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+
b+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"e":"w")+"'>"+b+"</span></a>":d?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+b+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"e":"w")+"'>"+b+"</span></a>";c=this._get(a,"nextText");c=g?this.formatDate(c,this._daylightSavingAdjust(new Date(D,z+e,1)),this._getFormatConfig(a)):c;d=this._canAdjustMonth(a,1,D,z)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+
(H?"w":"e")+"'>"+c+"</span></a>":d?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+c+"'><span class='ui-icon ui-icon-circle-triangle-"+(H?"w":"e")+"'>"+c+"</span></a>";e=this._get(a,"currentText");c=this._get(a,"gotoCurrent")&&a.currentDay?K:A;e=g?this.formatDate(e,c,this._getFormatConfig(a)):e;g=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+
"</button>";h=h?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(H?g:"")+(this._isInRange(a,c)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+e+"</button>":"")+(H?"":g)+"</div>":"";g=parseInt(this._get(a,"firstDay"),10);g=isNaN(g)?0:g;e=this._get(a,"showWeek");c=this._get(a,"dayNames");k=this._get(a,"dayNamesMin");l=this._get(a,"monthNames");m=this._get(a,"monthNamesShort");p=this._get(a,
"beforeShowDay");n=this._get(a,"showOtherMonths");q=this._get(a,"selectOtherMonths");t=this._getDefaultDate(a);r="";s;for(u=0;u<I[0];u++){F="";this.maxRows=4;for(v=0;v<I[1];v++){C=this._daylightSavingAdjust(new Date(D,z,a.selectedDay));s=" ui-corner-all";x="";if(E){x+="<div class='ui-datepicker-group";if(1<I[1])switch(v){case 0:x+=" ui-datepicker-group-first";s=" ui-corner-"+(H?"right":"left");break;case I[1]-1:x+=" ui-datepicker-group-last";s=" ui-corner-"+(H?"left":"right");break;default:x+=" ui-datepicker-group-middle",
s=""}x+="'>"}x+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+s+"'>"+(/all|left/.test(s)&&0===u?H?d:b:"")+(/all|right/.test(s)&&0===u?H?b:d:"")+this._generateMonthYearHeader(a,z,D,w,G,0<u||0<v,l,m)+"</div><table class='ui-datepicker-calendar'><thead><tr>";B=e?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(s=0;7>s;s++)y=(s+g)%7,B+="<th scope='col'"+(5<=(s+g+6)%7?" class='ui-datepicker-week-end'":"")+"><span title='"+c[y]+"'>"+k[y]+"</span></th>";
x+=B+"</tr></thead><tbody>";B=this._getDaysInMonth(D,z);D===a.selectedYear&&z===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,B));s=(this._getFirstDayOfMonth(D,z)-g+7)%7;B=Math.ceil((s+B)/7);this.maxRows=B=E?this.maxRows>B?this.maxRows:B:B;y=this._daylightSavingAdjust(new Date(D,z,1-s));for(J=0;J<B;J++){x+="<tr>";L=e?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>":"";for(s=0;7>s;s++)N=p?p.apply(a.input?a.input[0]:null,[y]):[!0,""],P=(M=y.getMonth()!==z)&&!q||
!N[0]||w&&y<w||G&&y>G,L+="<td class='"+(5<=(s+g+6)%7?" ui-datepicker-week-end":"")+(M?" ui-datepicker-other-month":"")+(y.getTime()===C.getTime()&&z===a.selectedMonth&&a._keyEvent||t.getTime()===y.getTime()&&t.getTime()===C.getTime()?" "+this._dayOverClass:"")+(P?" "+this._unselectableClass+" ui-state-disabled":"")+(M&&!n?"":" "+N[1]+(y.getTime()===K.getTime()?" "+this._currentClass:"")+(y.getTime()===A.getTime()?" ui-datepicker-today":""))+"'"+(M&&!n||!N[2]?"":" title='"+N[2].replace(/'/g,"&#39;")+
"'")+(P?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+"'")+">"+(M&&!n?"&#xa0;":P?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===A.getTime()?" ui-state-highlight":"")+(y.getTime()===K.getTime()?" ui-state-active":"")+(M?" ui-priority-secondary":"")+"' href='#'>"+y.getDate()+"</a>")+"</td>",y.setDate(y.getDate()+1),y=this._daylightSavingAdjust(y);x+=L+"</tr>"}z++;11<z&&(z=0,D++);x+="</tbody></table>"+
(E?"</div>"+(0<I[0]&&v===I[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");F+=x}r+=F}a._keyEvent=!1;return r+h},_generateMonthYearHeader:function(a,b,c,d,e,g,h,k){var l,m,p,n=this._get(a,"changeMonth"),q=this._get(a,"changeYear"),t=this._get(a,"showMonthAfterYear"),r="<div class='ui-datepicker-title'>",s="";if(g||!n)s+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;l=e&&e.getFullYear()===c;s+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";
for(m=0;12>m;m++)(!h||m>=d.getMonth())&&(!l||m<=e.getMonth())&&(s+="<option value='"+m+"'"+(m===b?" selected='selected'":"")+">"+k[m]+"</option>");s+="</select>"}t||(r+=s+(!g&&n&&q?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!q)r+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=this._get(a,"yearRange").split(":");p=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?p+parseInt(a,10):parseInt(a,10);return isNaN(a)?p:a};b=h(k[0]);
...
a.ghost&&a.helper&&a.helper.get(0).removeChild(a.ghost.get(0))}});d.ui.plugin.add("resizable","grid",{resize:function(){var a,b=d(this).resizable("instance"),c=b.options,f=b.size,e=b.originalSize,g=b.originalPosition,h=b.axis,k="number"===typeof c.grid?[c.grid,c.grid]:c.grid,l=k[0]||1,m=k[1]||1,p=Math.round((f.width-e.width)/l)*l,f=Math.round((f.height-e.height)/m)*m,n=e.width+p,q=e.height+f,t=c.maxWidth&&c.maxWidth<n,r=c.maxHeight&&c.maxHeight<q,s=c.minWidth&&c.minWidth>n,u=c.minHeight&&c.minHeight>
q;c.grid=k;s&&(n+=l);u&&(q+=m);t&&(n-=l);r&&(q-=m);if(/^(se|s|e)$/.test(h))b.size.width=n,b.size.height=q;else if(/^(ne)$/.test(h))b.size.width=n,b.size.height=q,b.position.top=g.top-f;else if(/^(sw)$/.test(h))b.size.width=n,b.size.height=q,b.position.left=g.left-p;else{if(0>=q-m||0>=n-l)a=b._getPaddingPlusBorderDimensions(this);0<q-m?(b.size.height=q,b.position.top=g.top-f):(q=m-a.height,b.size.height=q,b.position.top=g.top+e.height-q);0<n-l?(b.size.width=n,b.position.left=g.left-p):(n=l-a.width,
b.size.width=n,b.position.left=g.left+e.width-n)}}});d.widget("ui.dialog",{version:"1.11.4",options:{appendTo:"body",autoOpen:!0,buttons:[],closeOnEscape:!0,closeText:"Close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:null,maxWidth:null,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",of:window,collision:"fit",using:function(a){var b=d(this).css(a).offset().top;0>b&&d(this).css("top",a.top-b)}},resizable:!0,show:null,title:null,width:300,beforeClose:null,close:null,
...
lightness:{idx:2,type:"percent"}}}},m={"byte":{floor:!0,max:255},percent:{max:1},degrees:{mod:360,floor:!0}},p=k.support={},n=a("<p>")[0],q,t=a.each;n.style.cssText="background-color:rgba(1,1,1,.5)";p.rgba=-1<n.style.backgroundColor.indexOf("rgba");t(l,function(a,b){b.cache="_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(e,g,h,m){if(e===b)return this._rgba=[null,null,null,null],this;if(e.jquery||e.nodeType)e=a(e).css(g),g=b;var p=this,n=a.type(e),x=this._rgba=
[];g!==b&&(e=[e,g,h,m],n="array");if("string"===n)return this.parse(d(e)||q._default);if("array"===n)return t(l.rgba.props,function(a,b){x[b.idx]=c(e[b.idx],b)}),this;if("object"===n)return e instanceof k?t(l,function(a,b){e[b.cache]&&(p[b.cache]=e[b.cache].slice())}):t(l,function(b,d){var f=d.cache;t(d.props,function(a,b){if(!p[f]&&d.to){if("alpha"===a||null==e[a])return;p[f]=d.to(p._rgba)}p[f][b.idx]=c(e[a],b,!0)});p[f]&&0>a.inArray(null,p[f].slice(0,3))&&(p[f][3]=1,d.from&&(p._rgba=d.from(p[f])))}),
this},is:function(a){var b=k(a),c=!0,d=this;t(l,function(a,f){var e,g=b[f.cache];g&&(e=d[f.cache]||f.to&&f.to(d._rgba)||[],t(f.props,function(a,b){if(null!=g[b.idx])return c=g[b.idx]===e[b.idx]}));return c});return c},_space:function(){var a=[],b=this;t(l,function(c,d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,b){var d=k(a),f=d._space(),e=l[f],g=0===this.alpha()?k("transparent"):this,h=g[e.cache]||e.to(g._rgba),p=h.slice(),d=d[e.cache];t(e.props,function(a,f){var e=f.idx,g=h[e],
l=d[e],k=m[f.type]||{};null!==l&&(null===g?p[e]=l:(k.mod&&(l-g>k.mod/2?g+=k.mod:g-l>k.mod/2&&(g-=k.mod)),p[e]=c((l-g)*b+g,f)))});return this[f](p)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),f=k(b)._rgba;return k(a.map(c,function(a,b){return(1-d)*f[b]+d*a}))},toRgbaString:function(){var b="rgba(",c=a.map(this._rgba,function(a,b){return null==a?2<b?1:0:a});1===c[3]&&(c.pop(),b="rgb(");return b+c.join()+")"},toHslaString:function(){var b="hsla(",c=a.map(this.hsla(),
...
a[0]/255,c=a[1]/255,d=a[2]/255;a=a[3];var f=Math.max(b,c,d),e=Math.min(b,c,d),g=f-e,h=f+e,l=0.5*h,h=0===g?0:0.5>=l?g/h:g/(2-h);return[Math.round(e===f?0:b===f?60*(c-d)/g+360:c===f?60*(d-b)/g+120:60*(b-c)/g+240)%360,h,l,null==a?1:a]};l.hsla.from=function(a){if(null==a[0]||null==a[1]||null==a[2])return[null,null,null,a[3]];var b=a[0]/360,c=a[1],d=a[2];a=a[3];c=0.5>=d?d*(1+c):d+c-d*c;d=2*d-c;return[Math.round(255*e(d,c,b+1/3)),Math.round(255*e(d,c,b)),Math.round(255*e(d,c,b-1/3)),a]};t(l,function(d,
f){var e=f.props,h=f.cache,l=f.to,m=f.from;k.fn[d]=function(d){l&&!this[h]&&(this[h]=l(this._rgba));if(d===b)return this[h].slice();var f,g=a.type(d),p="array"===g||"object"===g?d:arguments,n=this[h].slice();t(e,function(a,b){var d=p["object"===g?a:b.idx];null==d&&(d=n[b.idx]);n[b.idx]=c(d,b)});return m?(f=k(m(n)),f[h]=n,f):k(n)};t(e,function(b,c){k.fn[b]||(k.fn[b]=function(f){var e=a.type(f),h="alpha"===b?this._hsla?"hsla":"rgba":d,l=this[h](),k=l[c.idx];if("undefined"===e)return k;"function"===
e&&(f=f.call(this,k),e=a.type(f));if(null==f&&c.empty)return this;"string"===e&&(e=g.exec(f))&&(f=k+parseFloat(e[2])*("+"===e[1]?1:-1));l[c.idx]=f;return this[h](l)})})});k.hook=function(b){b=b.split(" ");t(b,function(b,c){a.cssHooks[c]={set:function(b,e){var g,h="";if("transparent"!==e&&("string"!==a.type(e)||(g=d(e)))){e=k(g||e);if(!p.rgba&&1!==e._rgba[3]){for(g="backgroundColor"===c?b.parentNode:b;(""===h||"transparent"===h)&&g&&g.style;)try{h=a.css(g,"backgroundColor"),g=g.parentNode}catch(l){}e=
e.blend(h&&"transparent"!==h?h:"_default")}e=e.toRgbaString()}try{b.style[c]=e}catch(m){}}};a.fx.step[c]=function(b){b.colorInit||(b.start=k(b.elem,c),b.end=k(b.end),b.colorInit=!0);a.cssHooks[c].set(b.elem,b.start.transition(b.end,b.pos))}})};k.hook("backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor");a.cssHooks.borderColor={expand:function(a){var b={};t(["Top","Right","Bottom","Left"],function(c,
d){b["border"+d+"Color"]=a});return b}};q=a.Color.names={aqua:"#00ffff",black:"#000000",blue:"#0000ff",fuchsia:"#ff00ff",gray:"#808080",green:"#008000",lime:"#00ff00",maroon:"#800000",navy:"#000080",olive:"#808000",purple:"#800080",red:"#ff0000",silver:"#c0c0c0",teal:"#008080",white:"#ffffff",yellow:"#ffff00",transparent:[null,null,null,0],_default:"#ffffff"}})(Y);(function(){function a(a){var b,c=a.ownerDocument.defaultView?a.ownerDocument.defaultView.getComputedStyle(a,null):a.currentStyle,h={};
if(c&&c.length&&c[0]&&c[c[0]])for(a=c.length;a--;)b=c[a],"string"===typeof c[b]&&(h[d.camelCase(b)]=c[b]);else for(b in c)"string"===typeof c[b]&&(h[b]=c[b]);return h}var b=["add","remove","toggle"],c={border:1,borderBottom:1,borderColor:1,borderLeft:1,borderRight:1,borderTop:1,borderWidth:1,margin:1,padding:1};d.each(["borderLeftStyle","borderRightStyle","borderBottomStyle","borderTopStyle"],function(a,b){d.fx.step[b]=function(a){if("none"!==a.end&&!a.setAttr||1===a.pos&&!a.setAttr)Y.style(a.elem,
b,a.end),a.setAttr=!0}});d.fn.addBack||(d.fn.addBack=function(a){return this.add(null==a?this.prevObject:this.prevObject.filter(a))});d.effects.animateClass=function(f,e,g,h){var k=d.speed(e,g,h);return this.queue(function(){var e=d(this),g=e.attr("class")||"",h,n=k.children?e.find("*").addBack():e,n=n.map(function(){return{el:d(this),start:a(this)}});h=function(){d.each(b,function(a,b){if(f[b])e[b+"Class"](f[b])})};h();n=n.map(function(){this.end=a(this.el[0]);var b=this.start,f=this.end,e={},g,
h;for(g in f)h=f[g],b[g]===h||(c[g]||!d.fx.step[g]&&isNaN(parseFloat(h)))||(e[g]=h);this.diff=e;return this});e.attr("class",g);n=n.map(function(){var a=this,b=d.Deferred(),c=d.extend({},k,{queue:!1,complete:function(){b.resolve(a)}});this.el.animate(this.diff,c);return b.promise()});d.when.apply(d,n.get()).done(function(){h();d.each(arguments,function(){var a=this.el;d.each(this.diff,function(b){a.css(b,"")})});k.complete.call(e[0])})})};d.fn.extend({addClass:function(a){return function(b,c,h,k){return c?
d.effects.animateClass.call(this,{add:b},c,h,k):a.apply(this,arguments)}}(d.fn.addClass),removeClass:function(a){return function(b,c,h,k){return 1<arguments.length?d.effects.animateClass.call(this,{remove:b},c,h,k):a.apply(this,arguments)}}(d.fn.removeClass),toggleClass:function(a){return function(b,c,h,k,l){return"boolean"===typeof c||void 0===c?h?d.effects.animateClass.call(this,c?{add:b}:{remove:b},h,k,l):a.apply(this,arguments):d.effects.animateClass.call(this,{toggle:b},c,h,k)}}(d.fn.toggleClass),
...
h||g.hide(),b())}var f=a.pieces?Math.round(Math.sqrt(a.pieces)):3,e=f,g=d(this),h="show"===d.effects.setMode(g,a.mode||"hide"),k=g.show().css("visibility","hidden").offset(),l=Math.ceil(g.outerWidth()/e),m=Math.ceil(g.outerHeight()/f),p=[],n,q,t,r,s,u;for(n=0;n<f;n++)for(r=k.top+n*m,u=n-(f-1)/2,q=0;q<e;q++)t=k.left+q*l,s=q-(e-1)/2,g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",visibility:"visible",left:-q*l,top:-n*m}).parent().addClass("ui-effects-explode").css({position:"absolute",
...
d.effects.setTransition(l,t,g,l.from),l.to=d.effects.setTransition(l,t,f,l.to));"content"!==u&&"both"!==u||e===c||(v=v.concat(n).concat(p),l.from=d.effects.setTransition(l,n,e,l.from),l.to=d.effects.setTransition(l,n,c,l.to));d.effects.save(l,v);l.show();d.effects.createWrapper(l);l.css("overflow","hidden").css(l.from);k&&(k=d.effects.getBaseline(k,h),l.from.top=(h.outerHeight-l.outerHeight())*k.y,l.from.left=(h.outerWidth-l.outerWidth())*k.x,l.to.top=(h.outerHeight-l.to.outerHeight)*k.y,l.to.left=
(h.outerWidth-l.to.outerWidth)*k.x);l.css(l.from);if("content"===u||"both"===u)q=q.concat(["marginTop","marginBottom"]).concat(n),t=t.concat(["marginLeft","marginRight"]),p=m.concat(q).concat(t),l.find("*[width]").each(function(){var b=d(this),h=b.height(),l=b.width(),k=b.outerHeight(),m=b.outerWidth();s&&d.effects.save(b,p);b.from={height:h*e,width:l*g,outerHeight:k*e,outerWidth:m*g};b.to={height:h*c,width:l*f,outerHeight:h*c,outerWidth:l*f};e!==c&&(b.from=d.effects.setTransition(b,q,e,b.from),b.to=
...
"absolute"}).animate(f,a.duration,a.easing,function(){l.remove();b()})};d.widget("ui.progressbar",{version:"1.11.4",options:{max:100,value:0,change:null,complete:null},min:0,_create:function(){this.oldValue=this.options.value=this._constrainedValue();this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min});this.valueDiv=d("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);this._refreshValue()},
...
_precision:function(){var a=this._precisionOf(this.options.step);null!==this.options.min&&(a=Math.max(a,this._precisionOf(this.options.min)));return a},_precisionOf:function(a){a=a.toString();var b=a.indexOf(".");return-1===b?0:a.length-b-1},_valueMin:function(){return this.options.min},_valueMax:function(){return this.max},_refreshValue:function(){var a,b,c,f,e,g=this.options.range,h=this.options,k=this,l=this._animateOff?!1:h.animate,m={};if(this.options.values&&this.options.values.length)this.handles.each(function(c){b=
100*((k.values(c)-k._valueMin())/(k._valueMax()-k._valueMin()));m["horizontal"===k.orientation?"left":"bottom"]=b+"%";d(this).stop(1,1)[l?"animate":"css"](m,h.animate);if(!0===k.options.range)if("horizontal"===k.orientation){if(0===c)k.range.stop(1,1)[l?"animate":"css"]({left:b+"%"},h.animate);if(1===c)k.range[l?"animate":"css"]({width:b-a+"%"},{queue:!1,duration:h.animate})}else{if(0===c)k.range.stop(1,1)[l?"animate":"css"]({bottom:b+"%"},h.animate);if(1===c)k.range[l?"animate":"css"]({height:b-
a+"%"},{queue:!1,duration:h.animate})}a=b});else{c=this.value();f=this._valueMin();e=this._valueMax();b=e!==f?100*((c-f)/(e-f)):0;m["horizontal"===this.orientation?"left":"bottom"]=b+"%";this.handle.stop(1,1)[l?"animate":"css"](m,h.animate);if("min"===g&&"horizontal"===this.orientation)this.range.stop(1,1)[l?"animate":"css"]({width:b+"%"},h.animate);if("max"===g&&"horizontal"===this.orientation)this.range[l?"animate":"css"]({width:100-b+"%"},{queue:!1,duration:h.animate});if("min"===g&&"vertical"===
this.orientation)this.range.stop(1,1)[l?"animate":"css"]({height:b+"%"},h.animate);if("max"===g&&"vertical"===this.orientation)this.range[l?"animate":"css"]({height:100-b+"%"},{queue:!1,duration:h.animate})}},_handleEvents:{keydown:function(a){var b,c,f,e=d(a.target).data("ui-slider-handle-index");switch(a.keyCode){case d.ui.keyCode.HOME:case d.ui.keyCode.END:case d.ui.keyCode.PAGE_UP:case d.ui.keyCode.PAGE_DOWN:case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(a.preventDefault(),
...
b.cursor+" !important; }</style>").appendTo(f));b.opacity&&(this.helper.css("opacity")&&(this._storedOpacity=this.helper.css("opacity")),this.helper.css("opacity",b.opacity));b.zIndex&&(this.helper.css("zIndex")&&(this._storedZIndex=this.helper.css("zIndex")),this.helper.css("zIndex",b.zIndex));this.scrollParent[0]!==this.document[0]&&"HTML"!==this.scrollParent[0].tagName&&(this.overflowOffset=this.scrollParent.offset());this._trigger("start",a,this._uiHash());this._preserveHelperProportions||this._cacheHelperProportions();
...
var c="absolute"===a?1:-1,f="absolute"!==this.cssPosition||this.scrollParent[0]!==this.document[0]&&d.contains(this.scrollParent[0],this.offsetParent[0])?this.scrollParent:this.offsetParent,e=/(html|body)/i.test(f[0].tagName);return{top:b.top+this.offset.relative.top*c+this.offset.parent.top*c-("fixed"===this.cssPosition?-this.scrollParent.scrollTop():e?0:f.scrollTop())*c,left:b.left+this.offset.relative.left*c+this.offset.parent.left*c-("fixed"===this.cssPosition?-this.scrollParent.scrollLeft():
...
this.options.active,b=this.options.collapsible,c=location.hash.substring(1);null===a&&(c&&this.tabs.each(function(b,e){if(d(e).attr("aria-controls")===c)return a=b,!1}),null===a&&(a=this.tabs.index(this.tabs.filter(".ui-tabs-active"))),null===a||-1===a)&&(a=this.tabs.length?0:!1);!1!==a&&(a=this.tabs.index(this.tabs.eq(a)),-1===a&&(a=b?!1:0));!b&&(!1===a&&this.anchors.length)&&(a=0);return a},_getCreateEventData:function(){return{tab:this.active,panel:this.active.length?this._getPanelForTab(this.active):
d()}},_tabKeydown:function(a){var b=d(this.document[0].activeElement).closest("li"),c=this.tabs.index(b),f=!0;if(!this._handlePageNav(a)){switch(a.keyCode){case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:c++;break;case d.ui.keyCode.UP:case d.ui.keyCode.LEFT:f=!1;c--;break;case d.ui.keyCode.END:c=this.anchors.length-1;break;case d.ui.keyCode.HOME:c=0;break;case d.ui.keyCode.SPACE:a.preventDefault();clearTimeout(this.activating);this._activate(c);return;case d.ui.keyCode.ENTER:a.preventDefault();clearTimeout(this.activating);
this._activate(c===this.options.active?!1:c);return;default:return}a.preventDefault();clearTimeout(this.activating);c=this._focusNextTab(c,f);a.ctrlKey||a.metaKey||(b.attr("aria-selected","false"),this.tabs.eq(c).attr("aria-selected","true"),this.activating=this._delay(function(){this.option("active",c)},this.delay))}},_panelKeydown:function(a){!this._handlePageNav(a)&&(a.ctrlKey&&a.keyCode===d.ui.keyCode.UP)&&(a.preventDefault(),this.active.focus())},_handlePageNav:function(a){if(a.altKey&&a.keyCode===
