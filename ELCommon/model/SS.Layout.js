...
eLayout.welcomeHtml = function () {
	var tmp = '<nav class=" navbar-fixed-top" role="navigation">'
		...
		+ '               <img class = "navbar-weathericon img-weather"  src="ELCommon/view/images/ic_cloud.png"></img>'
		+ '             </div>'
		+ '             <div class="column media-right media-middle">'
		+ '               <span class=" textcolor temp-max">32&deg;C</span>'
		+ '             </div>'
		+ '       </div>'
		+ '      <div class="row logo col-lg-3" >'
...
eLayout.standbyHtml = function () {
	var tmp = '<nav class=" navbar-fixed-top" role="navigation" style="margin-top: 20px;">'
		...
		+ '               <h6 class="nav-lang-city sojo-textcolor" style = "font-size:20px" >NAM DINH CITY</h6>'
		+ '             </div>'
		+ '             <div class="column media-center media-middle text-right">'
		...
		+ '                        <span class=" textcolor temp-min" style="font-size: 25px">32&deg</span> <span class=" sojo-textcolor temp-max" style="font-size: 25px">32&deg</span><span class="textcolor" style="font-size: 25px">C</span>'
		+ '                    </div>'
		+ '                    <div class="col-md-6 media-center media-middle">'
		+ '                        <span class="nav-lang-today sojo-textcolor" style="font-size: 25px">TODAY</span>'
		+ '                    </div>'
		+ '               </div>'
		+ '               <div style="float: right;height: 125px;">'
		+ '                    <div class="col-md-6 media-center media-middle" >'
		+ '                         <img class = "navbar-weathericon img-weather"  src="ELCommon/view/images/ic_cloud_rainnew.png" style="width:180px; height:130px"></img>'
		+ '                    </div>'
		+ '                    <div class="col-md-6 media-center media-middle">'
		+ '                        <span class=" sojo-textcolor temp-avg" style="font-size: 80px">32&deg</span><span class=" textcolor" style="font-size: 80px">C</span>'
		+ '                    </div>'
		+ '               </div>'
		...
		+ '                    </div>'
		+ '                    <div class="column media-right media-middle">'
		+ '                        <span class=" sojo-textcolor" style="font-size: 25px">75%</span>'
		+ '                    </div>'
		+ '                    <div class="column media-right  media-middle" style="margin-top: 10px;">'
		+ '                        <img class = "navbar-weathericon "  src="ELCommon/view/images/ic_wind.png"></img>'
		+ '                    </div>'
		+ '                    <div class="column media-right media-middle">'
		+ '                        <span class=" sojo-textcolor" style="font-size: 25px">5 m/s</span>'
		+ '                    </div>'
		+ '               </div>'
		+ '            </div>'
		...
		+ '                        <span class="nav-lang-tomorrow sojo-textcolor" style="font-size: 25px">TOMOROW</span>'
		+ '                    </div>'
		+ '               </div>'
		+ '               <div style="float: right;height: 125px;">'
		+ '                    <div class="col-md-3 media-center media-middle" >'
		+ '                         <img class = "navbar-weathericon img-weather-tomorow"  src="ELCommon/view/images/ic_cloud_rainnew.png" style="width:180px; height:130px"></img>'
		+ '                    </div>'
		+ '                    <div class="col-md-9 media-center media-middle">'
		+ '                        <span class=" textcolor temp-min-tomorow" style="font-size: 80px">27&deg</span> <span class=" sojo-textcolor temp-max-tomorow" style="font-size: 80px">30&deg</span><span class=" textcolor" style="font-size: 80px">C</span>'
		+ '                    </div>'
		+ '               </div>'
		...
		+ '                    </div>'
		+ '                    <div class="column media-right media-middle">'
		+ '                        <span class=" sojo-textcolor" style="font-size: 25px">90%</span>'
		+ '                    </div>'
		+ '                    <div class="column media-right  media-middle" style="margin-top: 10px;">'
		+ '                        <img class = "navbar-weathericon "  src="ELCommon/view/images/ic_wind.png"></img>'
		+ '                    </div>'
		+ '                    <div class="column media-right media-middle">'
		+ '                        <span class=" sojo-textcolor" style="font-size: 25px">8-12 m/s</span>'
		+ '                    </div>'
		+ '               </div>'
		+ '            </div>'
		+ '       </div>'
		// +'<nav'
		// +'	class=" navbar-fixed-bottom navbar-background-bottom">'
		// +'	<div class="col-lg-9">'
		// +'		<div>'
		// +'			<div id="promotion-text-calc" style="display: none; white-space: nowrap; font-size: 17px;"></div>'
		// +'			<ul id="slide-promotion-footer"'
		// +'				style="margin-bottom: 0px; margin-left: 35px"></ul>'
		// +'		</div>'
		// +'	</div>'
		// +'	<div class="col-lg-3 text-right">'
		// +'		<h5 class="color-white">'
		// +'			Press <img src="ELCommon/view/images/ic_back.png"'
		// +'				style="width: 35px; height: 35px" /> To Back <img'
		// +'				src="ELCommon/view/images/ic_navigate.png"'
		...
		// + '      <div class="row logo col-lg-3" >'
		// + '             <div class="column media-left">'
		// + '               <span class="sojo-textcolor">ROOM <span class = "textcolor">101</span></span>'
		// + '             </div>'
		// + '       </div>'
		// + '      <div class="row logo col-lg-3" >'
		// + '             <div class="column media-right  media-middle" style="margin-top: 10px;">'
		// + '               <img class = "navbar-weathericon "  src="ELCommon/view/images/ic_cloud_rain.png"></img>'
		// + '             </div>'
		// + '             <div class="column media-right media-middle">'
		// + '               <span class=" textcolor temp-max">32&deg;C</span>'
		// + '             </div>'
		...
		// + '             </div>'
		// + '             <div class="column media-left media-middle">'
		// + '               <span class="sojo-textcolor ehotel-time-room">10:35</span><span class = "ehotel-timeperiod-room"><sup>PM<sup></span>'
		// + '             </div>'
		// + '       </div>'
		// + '      <div class="row logo col-lg-4">'
		// + '             <div class="column media-left media-middle" >'
...
eLayout.promotion = function (obj) {
	...
	var tmp = '<li><div data-url="' + obj.url + '" class="media" style="margin-left: 90px;">'
		+ '  <div class="media-body">'
		// + '    <h5 class="color-white">' + obj.title + '</h5>'
		+ '    <h6 class="sojo-colortext promotion-slow' + classes + '">' + obj.content + '</h6>'
		+ '  </div>'
		+ '</div></li>';
	return tmp;
}
